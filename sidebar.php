<?php if(!defined('PLX_ROOT')) exit; ?>
	...
	<aside class="aside col sml-12 med-4 w3-col l4 s12 article   " role="complementary">
<div class="sidebar w3-card-4 w3-theme-light w3-margin   w3-padding">
		<h3>
			<i class="fa fa-folder-open"></i> <?php $plxShow->lang('CATEGORIES'); ?>
		</h3>
		...
		<h3>
			<i class="fa fa-file-text-o" aria-hidden="true"></i> <?php $plxShow->lang('LATEST_ARTICLES'); ?>
		</h3>
		...
		<h3>
			<i class="fa fa-tags"></i> <?php $plxShow->lang('TAGS'); ?>
		</h3>
		...
		<h3>
			<i class="fa fa-comments-o" aria-hidden="true"></i> <?php $plxShow->lang('LATEST_COMMENTS'); ?>
		</h3>
		...
		<h3>
			<i class="fa fa-archive" aria-hidden="true"></i> <?php $plxShow->lang('ARCHIVES'); ?>
		</h3>
