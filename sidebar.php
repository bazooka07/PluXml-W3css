<?php if(!defined('PLX_ROOT')) exit; ?>
	...
	<aside class="w3-col l4 s12" role="complementary">
		<div class="w3-card-4 w3-theme-light w3-margin w3-padding">
			...
			<h3 class="w3-text-theme-dark"><i class="fa fa-folder-open" aria-hidden="true" ></i> <b><?php $plxShow->lang('CATEGORIES'); ?></b></h3>
			...
			<h3 class="w3-text-theme-dark"><i class="fa fa-file-text-o" aria-hidden="true"></i> <b><?php $plxShow->lang('LATEST_ARTICLES'); ?></b></h3>
			...
			<h3 class="w3-text-theme-dark"><i class="fa fa-tags" aria-hidden="true" ></i> <b><?php $plxShow->lang('TAGS'); ?></b></h3>
			...
			<h3 class="w3-text-theme-dark"><i class="fa fa-comments-o" aria-hidden="true"></i> <b><?php $plxShow->lang('LATEST_COMMENTS'); ?></b></h3>
			...
			<h3 class="w3-text-theme-dark"><i class="fa fa-archive" aria-hidden="true"></i> <b><?php $plxShow->lang('ARCHIVES'); ?></b></h3>
			...
			<h3 class="w3-text-theme-dark"><i class="fa fa-rss" aria-hidden="true"></i> <b>RSS</b></h3>
