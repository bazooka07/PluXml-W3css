...
<nav  role="navigation" >
	...
	<?php $plxShow->staticList('','<li class="w3-hide-small  #static_status" id="#static_id"><a href="#static_url" title="#static_name" class="w3-padding-large w3-hover-theme ">#static_name</a></li>', '<div class="w3-padding-large  w3-hover-theme ">#group_name</div>  ' ); ?>
	</ul>
